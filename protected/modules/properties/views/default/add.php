                                    ...
                                    <div class="padding-as25 margin-30 lgray-bg">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 col-sm-12 submit-description">
                                                ...
                                                <?php echo $form->textArea($model, 'description', array('col' => 10, 'row' => 30, 'class' => 'form-control margin-0','style'=>'height:150px !important ;', 'placeholder' => 'Property Description')); ?>
