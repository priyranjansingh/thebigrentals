...
class Users extends BaseModel {
    ...
    public function rules() {
        ...
        return array(
            array('id,confirm_password, password, email', 'required'),
            ...
            array('status, deleted, payment_status, is_admin', 'numerical', 'integerOnly' => true),
