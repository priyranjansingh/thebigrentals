...
function initialize() {
  ...
  var defaultBounds = new google.maps.LatLngBounds(
      new google.maps.LatLng(<?php echo $model->latitude; ?>, <?php echo $model->longitude; ?>),
      new google.maps.LatLng(<?php echo $model->latitude; ?>, <?php echo $model->longitude; ?>)
      );
...
<?php $form=$this->beginWidget('CActiveForm', array(
  ...
  <div class="row-fluid">
    ...
    ?>
      <div class="span4">
        <?php foreach($modelAmenities as $selectedAmenities): ?>
          <?php if($selectedAmenities->amenity_id == $amenity->id){
              $check = true;
            } ?>
        <?php endforeach; ?>
          <?php if($check): ?>
            <input type="checkbox" name="Property[amenities][]" value="<?php echo $amenity->id; ?>" checked="checked"> <?php echo $amenity->name; ?>
          <?php else : ?>
  ...
  <div class="row-fluid" id="price">
    <label>Property Price Table</label>
    <div class="span10">
    <table border='1' id="property_price_table">
            ...
            <?php endif; ?>
              <td>
                   ...
                   <select name="Property[Price][currency][]">
                            <?php foreach($currency as $c): ?>
                                  <?php if($c->id == $price->currency): ?>
                                    <option value="<?php echo $c->id; ?>" selected="selected"><?php echo $c->symbol; ?> (<?php echo $c->currency; ?>)</option>
                                  <?php else: ?>
                ...
                <td>
                    <input type="text" name="Property[Price][night_price][]" value="<?php echo $price->night_price; ?>" />
                </td>
                <td>
                    <input type="text" name="Property[Price][week_price][]" value="<?php echo $price->week_price; ?>" />
                </td>
                <td>
                  <input type="text" name="Property[Price][month_price][]" value="<?php echo $price->month_price; ?>" />
                </td>
                <td>
