...
class UsersController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Users']))
		{
			...
			if ($model->validate()){
				$model->password = AdminModule::encrypting($_POST['Users']['password']);
                $model->confirm_password = AdminModule::encrypting($_POST['Users']['confirm_password']);
                $model->save();
	...
	public function actionUpdate($id)
	{
		...
		$model->confirm_password = $prev_password;
		$roles = BaseModel::getAll('Roles');
                $package =  BaseModel::getAll('Package');
		// Uncomment the following line if AJAX validation is needed
		// $this->performAjaxValidation($model);
		...
		{
			$model->attributes=$_POST['Users'];
			if($_POST['Users']['password'] === $prev_password){
				if($_POST['Users']['confirm_password'] === $prev_password){
					if ($model->validate()){
						$model->save();
		                $this->redirect(array('view', 'id' => $model->id));
					}		
