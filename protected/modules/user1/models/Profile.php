...
class Profile extends BaseModel {
    ...
    public function rules() {
        ...
        return array(
            array('id,email,country', 'required'),
            array('title_position', 'required', 'on' => 'editprofile'),
            array('id, package_id, role_id, created_by, modified_by, activation_key', 'length', 'max' => 36),
            array('password,city,state,country, phone, mobile, email, website, skype, referral_code', 'length', 'max' => 100),
            array('nick_name', 'length', 'max' => 50),
            array('facebook_url, title_position, twitter_url, pinterest_url, user_image,addressLine1,addressLine2', 'length', 'max' => 256),
            array('created_date, modified_date, next_payment_date', 'safe'),
            // The following rule is used by search().
            // @todo Please remove those attributes that should not be searched.
            array('id, password,country, nick_name, phone, mobile, email, website, skype, facebook_url, title_position, twitter_url, pinterest_url, package_id, role_id, status, deleted, payment_status, user_image, created_date, created_by, modified_date, modified_by, referral_code, is_admin, next_payment_date, activation_key', 'safe', 'on' => 'search'),
        );
    }
