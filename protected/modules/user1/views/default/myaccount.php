                            ...
                            <div class="tab-pane fade in <?php if(empty($msg)): ?>active<?php endif; ?>" id="tab-1">
                                <div class="tab-body">
                                    <dl class="dl-horizontal style-2">
                                        ...
                                        <p class="mb-20"><?php echo $model->about_me; ?></p>

                                        <dt>Your name</dt>
                                        <dd>
                                            <span class="pull-left"><?php echo $model->title_position . ' ' . $model->first_name . ' ' . $model->last_name; ?></span>
                                        </dd>
                                        <hr>
                                        <dt>Email</dt>
                                        <dd>
                                        ...
                                        <dt>Country</dt>
                                        <dd>
                                            <span class="pull-left"><?php echo $model->country; ?></span>
                                        </dd>
                                        <hr>
                                        <dt>Phone</dt>
                                        <dd>
