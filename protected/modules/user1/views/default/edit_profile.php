                            ...
                            <div class="tab-pane fade in active" id="tab-1">
                                ...
                                <div class="tab-body">
                                    <dl class="dl-horizontal style-2">
                                        ...
                                        <dt><?php echo $form->labelEx($model, 'title_position'); ?></dt>
                                        <dd>
                                            <span class="pull-left">
                                                <?php echo $form->dropDownList($model, 'title_position', getParam('title_position')); ?>
<?php echo $form->error($model, 'title_position'); ?>
                                            </span>
                                        </dd>
                                        <hr>
                                        <dt><?php echo $form->labelEx($model, 'nick_name'); ?></dt>
                                        <dd>
                                            <span class="pull-left">
...
<?php echo $form->error($model, 'email'); ?>
                                        ...
                                        <dd>
                                            <span class="pull-left">
                                                <?php echo $form->textField($model, 'country', array('size' => 50, 'maxlength' => 100)); ?>
...
<?php echo $form->error($model, 'pinterest_url'); ?>
                                        ...
                                        <hr>
                                        <dt><?php echo $form->labelEx($model, 'about_me'); ?></dt>
                                        <dd>
                                            <span class="pull-left">
                                                <?php echo $form->textArea($model, 'about_me', array('col' => 4, 'row' => 10)); ?>
