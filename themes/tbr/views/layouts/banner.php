        ...
        <div id="search" class="width-limit">
            <form id="search_form" accept-charset="UTF-8" action="<?php echo base_url(); ?>/properties/search" method="POST">
                <div class="col-sm-12 col-md-4">
                    <div>
                        <input name="query" id="search-location" onFocus="geolocate()" class="form-control input-lg form-control-icon icon-location typeahead" type="text" placeholder="Where are you going?" value="" autocomplete="off">
                    </div>
